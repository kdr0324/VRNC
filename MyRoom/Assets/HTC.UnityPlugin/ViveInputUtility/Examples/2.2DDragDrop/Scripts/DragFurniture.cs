...
public class DragFurniture : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
...
//        draggingImage.SetNativeSize();
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        Debug.Log("Current Raycast hit name is " + eventData.pointerCurrentRaycast.gameObject.tag);
        //가구아이콘 드래그 시 가구 만듬
